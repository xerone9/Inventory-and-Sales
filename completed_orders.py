...
# Reports
from completed_orders_report import completed_report

def completed_orders():
    top = Toplevel()
    top.title('All Orders')
    ...
    def print_report():
        ...
        completed_report(from_date_is, to_date_is)
    ...
    get_orders_button = Button(top, text="GET ORDERS", font=("Arial", 15, 'bold'), justify='center',
                                     cursor="hand1", command=print_report)
    get_orders_button.configure(foreground="white")
    get_orders_button.configure(bg="blue")
    get_orders_button.grid(row=1, column=1, columnspan=2, padx=10, pady=10)