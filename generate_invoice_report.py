...
def generate_invioce_report(invoice_no):
    class PDF(FPDF):
        def header(self):
    ...
    save_location = os.path.expanduser('~/Documents/' + company_name + 'Invoices/')
    if not os.path.exists(save_location):
        os.makedirs(save_location)
    pdf.output(save_location + str(customer_name) + " (" + str(invoice_no) + ").pdf")
    os.startfile(save_location + str(customer_name) + " (" + str(invoice_no) + ").pdf")
