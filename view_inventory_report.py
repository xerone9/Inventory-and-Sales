...
def view_inventory_report():
    class PDF(FPDF):
        def header(self):
            ...
            self.cell(60)
            # Title
            self.cell(85, 20, 'TOTAL INVENTORY', border=True, ln=0, align='C')
    ...
    for value in items:
        ...
        pdf.cell(15, 10, str(count), border=True, align='L', ln=0)
        pdf.set_font('times', 'B', 14)
        pdf.cell(60, 10, str(inventory_type), border=True, align='L', ln=0)
        pdf.set_font('times', 'I', 16)
        pdf.cell(60, 10, str(inventory_name), border=True, align='L', ln=0)
        pdf.set_font('times', '', 16)
        pdf.cell(25, 10, str(inventory_rate) + " Rs.", border=True, align='L', ln=0)
        pdf.set_font('times', 'B', 16)
        pdf.cell(28, 10, str("{:,}".format(inventory_total_quantity)), border=True, align='L', ln=1)
